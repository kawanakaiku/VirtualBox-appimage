...
libpipewire pipewire pipewire-alsa pipewire-audio pipewire-pulse qt6-wayland" #SYNTAX: "APP1 APP2 APP3 APP4...", LEAVE BLANK IF NO OTHER DEPENDENCIES ARE NEEDED
